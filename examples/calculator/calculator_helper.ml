...
module M (Driver : Taype_driver.S) = struct
  ...
  let rec expr_to_sexp = function
    ...
    | Add (e1, e2) ->
        Sexp.List [ Sexp.Atom "+"; expr_to_sexp e1; expr_to_sexp e2 ]
    | Sub (e1, e2) ->
        Sexp.List [ Sexp.Atom "-"; expr_to_sexp e1; expr_to_sexp e2 ]
    | Mul (e1, e2) ->
        Sexp.List [ Sexp.Atom "*"; expr_to_sexp e1; expr_to_sexp e2 ]
  ...
  let rec expr_of_sexp = function
    | Sexp.List [ Sexp.Atom "+"; e1; e2 ] ->
        Add (expr_of_sexp e1, expr_of_sexp e2)
    | Sexp.List [ Sexp.Atom "-"; e1; e2 ] ->
        Sub (expr_of_sexp e1, expr_of_sexp e2)
    | Sexp.List [ Sexp.Atom "*"; e1; e2 ] ->
        Mul (expr_of_sexp e1, expr_of_sexp e2)
    | Sexp.List [ Sexp.Atom "/"; e1; e2 ] ->
        Div (expr_of_sexp e1, expr_of_sexp e2)
